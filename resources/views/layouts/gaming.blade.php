    ...
    @endauth
                ...
                <div class="hidden md:flex items-center space-x-3">
                    @auth
                        ...
                        <a href="{{ route('profile.edit') }}" class="text-gray-600 hover:text-blue-600 text-sm font-medium">Profil</a>
...
<div x-show="open" x-transition class="md:hidden border-t border-gray-100 bg-white pb-4">
    <div class="px-2 pt-3 space-y-1">
        @auth
            ...
            <a href="{{ route('booking.choose') }}" class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg text-sm font-medium">Booking</a>
            <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg text-sm font-medium">Profil</a>
            <hr class="my-2">
            <form method="POST" action="{{ route('logout') }}">
                @csrf

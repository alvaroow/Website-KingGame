                        ...
                        <tr>
                            ...
                            <td class="px-3 py-2">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('admin.devices.edit', $device) }}" class="text-blue-600 hover:text-blue-800 text-xs whitespace-nowrap">Edit</a>
                                    <form action="{{ route('admin.devices.destroy', $device) }}" method="POST" onsubmit="return confirm('Hapus permanen?')" class="inline">
                                        @csrf @method('DELETE')
                                        <button class="text-red-600 hover:text-red-800 text-xs whitespace-nowrap">Hapus</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
